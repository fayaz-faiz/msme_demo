...
const GET_ABOUT_US = "/static/about-us";
const GET_PRIVACY_POLICY = "/static/privacy-policy";
const GET_TERMS_CONDITIONS = "/static/terms-condition";
...
export {
    ...
    GET_CANCELLATION_TERMS, CONTACT_US_API, REPEAT_ORDER, UPLOAD_PROFILE, LATEST_ORDER, GET_ABOUT_US, GET_PRIVACY_POLICY, GET_TERMS_CONDITIONS
}
